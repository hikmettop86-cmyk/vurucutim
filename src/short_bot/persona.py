...
def persona_block(persona: Persona, *, seed: int = 0, curated: bool = False) -> str:
    ...
    return (
        ...
        "  • HİTAP SESLENMEDİR, SIFAT DEĞİL: 'koçum/reis/kardeş' izleyiciye ya da özneye\n"
        "    SESLENİR — rastgele bir isme YAPIŞTIRMA. 'kanepe koçum', 'salon reis' gibi\n"
        "    tamlamalar ANLAMSIZ/BOZUK Türkçedir → YASAK. Doğrusu ya seslenme ('...koçum,'\n"
        "    diye cümleye ekle) ya da doğru tamlama ('kanepedeki koçum', 'salondaki aile').\n"
        "  • DOĞRU + DOĞAL TÜRKÇE ŞART: mahalle ağzı bir TON/REGISTER'dır, bozuk sözdizimi\n"
        "    bahanesi DEĞİL. Her cümle dilbilgisel doğru ve akıcı olmalı; bir slang/metafor\n"
        "    cümleye OTURMUYORSA AT (anlamsız yığmaktansa sade söyle). Metaforun ÖZNESİ net\n"
        "    olsun — 'alkışa boğuluyor' diyorsan KİM alkışlanıyor belli olsun.\n\n"
