...
def topic_guidance(persona: Persona | None) -> str:
    ...
    return (
        ...
        "GÖRSEL OLARAK GÖSTERİLEBİLİR OLMALI (EN ÖNEMLİ — kullanıcı geri bildirimi): "
        "Bu videolar STOK FOOTAGE üstüne anlatılır. Konu, stok kütüphanenin GERÇEKTEN "
        "GÖSTEREBİLECEĞİ bir GÖRÜNÜR olay olmalı: kavga, kovalamaca, avlanma, meydan "
        "okuma, güç gösterisi, pusu, sürü davranışı — hayvanın BEDENİYLE yaptığı, "
        "kamerada GÖRÜNEN bir eylem. KESİN KAÇIN: stok footage'ı OLMAYAN mikro/soyut "
        "detaylar — 'susamuru favori taşını CEBİNDE saklar', 'tilki KUZEYE bakarak "
        "avlanır', 'akbaba çamura MİNERAL için bulanır', 'balık deniz tabanına MOTİF "
        "çizer'. Bunlar ilginç bilgidir ama izleyici ekranda o taşı/yönü/motifi GÖREMEZ "
        "(sadece 'hayvan yüzüyor' görür) ve 'anlatılan bu değil' deyip kopar. ÖLÇÜLDÜ: "
        "susamuru-taş videosunda 4 karenin hepsi 'samur suda yüzüyor'du, taş yoktu. "
        "TEST: 'Bu olayı Pexels'te aratsam hayvanın bunu YAPARKEN görüntüsü çıkar mı?' "
        "Çıkmıyorsa o konuyu ALMA.\n"
...
def persona_block(persona: Persona) -> str:
    ...
    return (
        ...
        "  • GÖRSEL SADAKAT: video, hayvanın stok görüntüsü üstüne anlatılır. Anlatımın\n"
        "    ANA EKSENİ, ekranda GÖRÜNEN bir eylem olsun (hayvanın yürüyüşü, saldırısı,\n"
        "    duruşu, kavgası). Ekranda GÖRÜNMEYEN küçük bir nesneyi/ayrıntıyı ('koltuk\n"
        "    altındaki taş', 'mikroskobik salgı') VİDEONUN OMURGASI YAPMA — izleyici onu\n"
        "    göremez, 'anlatılan bu değil' der. Böyle bir ayrıntı geçecekse yalnızca bir\n"
        "    espri olarak değsin geç, sahneyi onun üstüne kurma.\n\n"
