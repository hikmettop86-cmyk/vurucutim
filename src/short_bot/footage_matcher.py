...
_STORYBOARD_PROMPT = (
    ...
    "EYLEMİN YÖNÜ — EN SIK HATA: İLK kareyle SON kareyi KARŞILAŞTIR ve ekranda NE ÇOĞALDI, "
    "NE EKSİLDİ onu belirle; yönü buna göre yaz. Ekleme/çıkarma, takma/SÖKME, açma/kapama, "
    "giydirme/çıkarma, doldurma/boşaltma çiftlerinde yön kolayca TERS yazılıyor ve hikâyenin "
    "tamamı ters dönüyor. GERÇEK örnek-hata: duvar ilk karede baştan sona GAZETEYLE kaplı, son "
    "karede gazete yok, yerinde SARI NOTLAR var → adam gazeteleri SÖKÜYOR (altındaki sürprizi "
    "açıyor); 'kağıtları duvara yapıştırıyor' demek olayı TERSİNE çevirir. Emin olamıyorsan "
    "hangi yönde olduğunu YAZMA — yalnız neyin arttığını/azaldığını söyle.\n"
